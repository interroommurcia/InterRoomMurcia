  ...
  if (status === "sent") {
    return (
      <div className="lead-sent">
        ...
        <p>Te contactamos en menos de 24h con una valoracion de tu inmueble.</p>
        <a href={whatsappHref(`${WA_MSG} Direccion: ${form.direccion}.`)} target="_blank" rel="noopener noreferrer" className="btn-primary">
  ...
  return (
    <form className="lead-form" onSubmit={handleSubmit}>
      ...
      <label>
        ...
        <input required maxLength={200} value={form.direccion} onChange={(e) => setForm({ ...form, direccion: e.target.value })} placeholder="Calle, barrio o zona en Murcia o Cartagena" />
      </label>
      <div className="lead-form-row">
        <label>
          Email (opcional)
      ...
      <label>
        ...
        <textarea maxLength={500} rows={3} value={form.mensaje} onChange={(e) => setForm({ ...form, mensaje: e.target.value })} placeholder="Metros cuadrados, estado del inmueble, motivo de venta..." />
      </label>
